...
def run():
    ...
    train_dataset = TextAudioSpeakerLoader(hps.data.training_files.replace("./data","./Data").replace("\\","/"), hps.data)
    ...
    if rank == 0:
        eval_dataset = TextAudioSpeakerLoader(hps.data.validation_files.replace("./data","./Data").replace("\\","/"), hps.data)
